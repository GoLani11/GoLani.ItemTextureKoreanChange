...
- Codex가 원본 mip 0을 원본 상세도로 먼저 보고 모든 대상 영역을 기록해야 한다.
...
- 결과 OCR에서 확정 한국어의 철자·횟수가 맞고 누락·중복·금지 외국어 잔상이 없어야 한다.
...
- 공유 보조맵 소비자를 모두 확인하고 사광 진단에서 기존 외국어가 보이지 않아야 한다.
...
- D/N/G 진단에서 외국어 효과, 중복, seam, 흐림과 정렬 오류가 없어야 한다.
